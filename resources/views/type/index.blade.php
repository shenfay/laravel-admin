...
@section('button')
<button data-modal="{{ route('admin.types.create', ['model'=>$class]) }}" data-title="添加类别" class="layui-btn layui-btn-sm">添加类别</button>
@stop
                    ...
                    <tbody>
                        @foreach($list as $key => $vo)
                            <tr>
                                ...
                                <td class="text-left">
                                    <a data-title="编辑类别" data-modal="{{ route('admin.types.edit', ['model'=>$class, 'type'=>$vo->id]) }}">编辑</a>
